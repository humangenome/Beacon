...
### Self-hosted servers
1. Download `Beacon-Server-Windows-x64-v<version>.zip` from the [latest release](https://github.com/HumanGenome/Beacon/releases/latest).
...
- `Beacon-Server-Windows-x64-v<version>.zip` — server package for hosts
